...
function liquidFillGaugeDefaultSettings(){
    return {
        ...
        circleColor: "#01366f", // The color of the outer circle.
        circleFill: '#0D4285', // The fill color of the circle.  Can be set to "transparent"
        ...
        waveColor: "#0081d4", // The color of the fill wave.
        waveOffset: 0, // The amount to initially offset the wave. 0 = no offset. 1 = offset of one full wave.
        textVertPosition: 0.85, // The height at which to display the percentage text withing the wave circle. 0 = bottom, 1 = top.
...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    gaugeGroup.append("text")
        ...
        .attr("font-size", "50px")
        .style("fill", "#0d3872")
        .attr('transform','translate('+radius+','+textRiseScaleY(config.textVertPosition2)+')');

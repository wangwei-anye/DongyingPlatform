<template>
  <div class="permission-page">
    <v-two-header title="权限管理"></v-two-header>
    <v-prole :provinces="provinces" @createdUserHandler="createdUserSuccess"></v-prole>
    <v-puser :provinces="provinces" :update="updatedPuser"></v-puser>
    <v-password-modal />
    <v-username-modal />
    <v-logout-modal />
  </div>
...
export default {
  ...
  methods: {
    ...
    queryProvices () {
      http.post('/account/rolePermissionManager/selectProvices.do').then(res => {
